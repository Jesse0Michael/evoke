...
// was not loaded in eager-loading.
func (e UserEdges) ArtifactsOrErr() ([]*Artifact, error) {
	if e.loadedTypes[1] {
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldID, user.FieldUsername, user.FieldEmail, user.FieldName, user.FieldAvatarURL:
...
// QueryArtifacts queries the "artifacts" edge of the User entity.
func (u *User) QueryArtifacts() *ArtifactQuery {
	return NewUserClient(u.config).QueryArtifacts(u)
}
